export default {
  ...
  "label-concurrent-downloads": "同時ダウンロード数",
  "label-custom-directory": "保存先ディレクトリ",
  "label-content": "コンテンツ",
  ...
  "label-version": "バージョン",
  "label-scraper-version": "スクレイパーコア",
  "label-scraper-update-available": "スクレイパー更新のお知らせ",
  "label-scraper-updated-title": "スクレイパー更新完了",
  "label-scraper-updated-desc": "スクレイパーコアが更新されました：",
  "label-scraper-uptodate-title": "スクレイパーコア",
  "label-scraper-uptodate-desc": "スクレイパーコアは既に最新バージョンです。",
